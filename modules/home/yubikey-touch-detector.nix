# Adapted from https://github.com/berbiche/dotfiles/blob/4048a1746ccfbf7b96fe734596981d2a1d857930/modules/home-manager/yubikey-touch-detector.nix#L9
{
  inputs,
  config,
  lib,
...
let
  cfg = config.introdus.services.yubikey-touch-detector;
in
{
  options.introdus.services.yubikey-touch-detector = {
